...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-fields&moduleid=<?php echo $this->tpl_var['module']['moduleid']; ?>">字段管理</a></li>
				...
				<div class="box itembox">
					<h4 class="title" style="padding:10px;">
						...
						<?php } ?>
						<a class="pull-right btn btn-primary" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-fields&moduleid=<?php echo $this->tpl_var['module']['moduleid']; ?>">字段列表</a>
					</h4>
					<form action="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-addfield" method="post" class="form-horizontal">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<div class="input-group">
										<span class="input-group-addon"><?php echo $this->tpl_var['module']['modulecode']; ?>_</span>
										<input class="form-control" type="text" size="40" name="args[field]" needle="needle" datatype="datatable" id="field" msg="您必须填写字段名称，必须为英文字符和数字"/>
									</div>
									<span class="help-block">填写英文字符或数字组成的字段名称</span>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select class="form-control combox" name="args[fieldhtmltype]" id="fieldhtmltype">
						          		...
						          		<option value="videotext">上传(videotext)</option>
									</select>
					          	</div>
							</div>
					        <div class="form-group">
 ...
 $gid++; ?>
						          	...
						          	<label class="checkbox-inline">
						          		<input type="checkbox" class="form-control" name="args[fieldforbidactors][]" value="<?php echo $group['groupid']; ?>"/> <?php echo $group['groupname']; ?>
						          	</label>
						          	<?php } ?>
						          	<?php } ?>
								</div>
