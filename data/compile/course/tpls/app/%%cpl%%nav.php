<div class="container-fluid box" style="margin:0px auto;padding-top:10px;overflow:visible">
	<div class="row-fluid">
		<div class="main">
			<div class="col-xs-3">
				<h1 style="font-size:42px;color:#337AB7;"><img src="app/core/styles/img/logo2.png" style="height:60px;margin-top:-10px;"/>&nbsp;<b>在线考试</b></h1>
			</div>
			<div class="col-xs-1">
			</div>
					...
					<li>
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								...
								<?php if($this->tpl_var['_user']['teacher_subjects']){ ?><li><a href="index.php?exam-teach"><em class="glyphicon glyphicon-dashboard"></em> 教师管理</a></li><?php } ?>
		...
		<div class="main">
			<div class="col-xs-12">
				<ul class="list-unstyled list-inline">
					...
					<li class="menu col-xs-1 active"><a href="index.php?course">课程</a></li>
