...
<?php } ?>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						题冒题管理
						<a class="btn btn-primary pull-right" href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-rowsquestions-addquestionrows&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">题冒添加</a>
					</h4>
 ...
 $qid++; ?>
							        <tr>
										...
										<td>
											<a title="查看试题" class="selfmodal" href="javascript:;" url="index.php?exam-teach-rowsquestions-detail&questionid=<?php echo $question['qrid']; ?>&<?php echo TIME; ?>" data-target="#modal"><?php echo $this->G->make('strings')->subString(strip_tags(html_entity_decode($question['qrquestion'])),135); ?></a>
										</td>
										<td>
										...
										<td>
											<div class="btn-group">
					                    		<a class="btn" href="index.php?exam-teach-rowsquestions-rowsdetail&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="子试题列表"><em class="glyphicon glyphicon-th-list"></em></a>
												<a class="btn" href="index.php?exam-teach-rowsquestions-modifyquestion&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="修改"><em class="glyphicon glyphicon-edit"></em></a>
												<a class="btn confirm" href="index.php?exam-teach-rowsquestions-delquestion&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="删除"><em class="glyphicon glyphicon-remove"></em></a>
					                    	</div>
										</td>
							        </tr>
							        <?php } ?>
