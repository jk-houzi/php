...
<div class="container-fluid" id="datacontent">
	<div class="row-fluid">
		...
		<div class="main box">
			<form id="form1" name="form1" class="col-xs-12" action="index.php?exam-app-exercise-makescore">
 ...
 $qnid++; ?>
	            ...
	            <div class="box itembox paperexamcontent">
	                ...
	                <div class="choice" style="line-height:2.5em;">
                  		【请根据参考答案给出分值】
                  		<input type="text" class="col-xs-1" name="score[<?php echo $question['questionid']; ?>]" value="" maxvalue="1">
 ...
 $did++; ?>
	                ...
	                <blockquote style="background:#FFFFFF;border-right:1px solid #CCCCCC;border-top:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC;">
		                ...
		                <div class="choice" style="line-height:2.5em;">
	                  		【请根据参考答案给出分值】
	                  		<input type="text" class="col-xs-1" name="score[<?php echo $data['questionid']; ?>]" value="" maxvalue="1">
	                  		<span class="text-error">提示：本题共1分，可输入0.5的倍数。</span>
	                  	</div>
					</blockquote>
					<?php } ?>
