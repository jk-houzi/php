...
<div class="container-fluid" id="questioncontent">
 ...
 $did++; ?>
			...
			<form id="form1" name="form1" method="post" action="index.php?exam-app-exercise-score" class="col-xs-9 split pull-right" style="padding:0px;">
				...
				<div class="box itembox paperexamcontent" id="questions_<?php echo $data['questionid']; ?>" rel="<?php echo $quest; ?>">
	                ...
	                <blockquote class="" style="background:#FFFFFF;border-right:1px solid #CCCCCC;border-top:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC;">
						<h4 class="title">
							第<?php echo $did; ?>题
							<span class="pull-right">
								<a class="btn btn-primary qicon" href="javascript:;" onclick="javascript:favorquestion('<?php echo $data['questionid']; ?>');"><i class="glyphicon glyphicon-heart-empty"></i></a>
