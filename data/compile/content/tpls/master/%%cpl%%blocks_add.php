							...
							<div id="panel-411980" class="tab-pane active">
								<form action="index.php?content-master-blocks-add" method="post" class="form-horizontal" style="margin-top:20px;">
							        ...
							        <div class="form-group">
					            		...
					            		<div class="col-sm-9">
					            			<textarea class="ckeditor" id="blockcontent_content" class="ckeditor" name="args[blockcontent][content]" rows="7" cols="4"><?php echo $this->tpl_var['block']['blockcontent']['content']; ?></textarea>
							        	</div>
							        </div>
							        <div class="form-group">
							...
							<div id="panel-376313" class="tab-pane">
								<form action="index.php?content-master-blocks-add" method="post" class="form-horizontal" style="margin-top:20px;">
							        <div class="form-group">
							            <label for="block" class="control-label col-sm-2">名称：</label>
							            <div class="col-sm-9">
							            	<input class="form-control" type="text" id="block" name="args[block]" needle="needle" msg="您必须输入标签名称" max="40" value="<?php echo $this->tpl_var['block']['block']; ?>">
							        	</div>
							        </div>
							        <div class="form-group">
							            <label for="blockposition" class="control-label col-sm-2">位置：</label>
							...
							<div id="panel-376314" class="tab-pane">
								<form action="index.php?content-master-blocks-add" method="post" class="form-horizontal" style="margin-top:20px;">
							        <div class="form-group">
							            <label for="block" class="control-label col-sm-2">名称：</label>
							            <div class="col-sm-9">
							            	<input class="form-control" type="text" name="args[block]" id="block" needle="needle" msg="您必须输入标签名称" max="40" value="<?php echo $this->tpl_var['block']['block']; ?>">
							        	</div>
							        </div>
							        <div class="form-group">
							            <label for="blockposition" class="control-label col-sm-2">位置：</label>
