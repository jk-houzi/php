				...
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
						<div class="col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module">模型管理</a></li>
					...
					<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
						<h4 class="title" style="padding:10px;">
							添加模型
							<a class="pull-right btn btn-primary" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module">模型列表</a>
						</h4>
						<form action="index.php?<?php echo $this->tpl_var['_app']; ?>-master-module-add" method="post" class="form-horizontal">
							<fieldset>
